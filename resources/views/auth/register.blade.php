...
<style>
body {
	background-image: url('https://wallpapercave.com/uwp/uwp945881.jpeg');
 ...
 <div class="row mb-3">
     <form action="{{route('postRegister')}}" method="POST" class="col-md-6 col-xs-12 offset-md-3 auth-formm" method="POST" class="col-md-6 col-xs-12 offset-md-3 "  id="regitration_form">
     	  @csrf
